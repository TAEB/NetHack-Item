...
use Test::NetHack::Items (
    ...
    "S - the +0 Cleaver",
    {appearance => "double-headed axe", identity => "battle-axe", artifact => 'Cleaver'},
    "X - the Eye of the Aethiopica",
    {appearance => undef, identity => "amulet of ESP", artifact => 'Eye of the Aethiopica'},
    "X - the Mitre of Holiness",
    {appearance => undef, identity => "helm of brilliance", artifact => 'Mitre of Holiness'},
    ...
    {appearance => "key", identity => "skeleton key", artifact => 'Master Key of Thievery'},
    ...
    {appearance => "gray stone", identity => "luckstone", artifact => 'Heart of Ahriman'},
