...
use Test::NetHack::Items (
    ...
    {appearance => "double-headed axe", identity => "battle-axe"},
    "f - a battle-axe named Cleaver",
    {appearance => "double-headed axe", identity => "battle-axe"},
    "f - a pyramidal amulet named The Eye of the Aethiopica",
    {appearance => "pyramidal amulet", artifact => undef, is_artifact => undef},
    "f - an amulet of ESP named The Eye of the Aethiopica",
    {appearance => undef, identity => "amulet of ESP", artifact => "Eye of the Aethiopica", is_artifact => 1},
    "X - a visored helmet named The Mitre of Holiness",
    {appearance => "visored helmet", identity => undef, artifact => undef, is_artifact => undef},
    "X - the helm of brilliance named The Mitre of Holiness",
    {appearance => undef, identity => "helm of brilliance", artifact => 'Mitre of Holiness', is_artifact => 1},
    "A - a crude ring mail",
