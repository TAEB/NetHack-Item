...
use Test::NetHack::Items (
    ...
    {appearance => "pyramidal amulet", identity => "amulet of ESP"},
    "f - an amulet of ESP named The Eye of the Aethiopica",
    {appearance => undef, identity => "amulet of ESP"},
    "X - a visored helmet named The Mitre of Holiness",
    {appearance => "visored helmet", identity => "helm of brilliance", is_artifact => undef},
    "X - the helm of brilliance named The Mitre of Holiness",
    {appearance => undef, identity => "helm of brilliance", is_artifact => 1},
    "A - a crude ring mail",
